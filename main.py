...
def attack(char_name: str, char_class: str) -> str:
    """Функция подсчёта урона противнику в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция подсчёта заблокированного урона от противника.
...
def special(char_name: str, char_class: str) -> str:
    """Функция выводящая специальное умение в зависимости от класса."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Функция описания и его подтверждения."""
